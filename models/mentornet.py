...
class MentorNet(nn.Module):
    def __init__(self,MentorNet_type='MentorNet',label_embedding_size=2, epoch_embedding_size=5, num_label_embedding=2, num_fc_nodes=20):
...
# def MentorNet(args):
#     return MentorNet_arch(args.mnet_type)